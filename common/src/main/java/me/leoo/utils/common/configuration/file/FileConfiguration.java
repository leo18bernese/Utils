package me.leoo.utils.common.configuration.file;

import com.google.common.base.Charsets;
import com.google.common.io.Files;
import me.leoo.utils.common.configuration.Configuration;
import me.leoo.utils.common.configuration.InvalidConfigurationException;
import me.leoo.utils.common.configuration.MemoryConfiguration;
...
public abstract class FileConfiguration extends MemoryConfiguration {
    ...
    public void save(File file) throws IOException {
        ...
        try (Writer writer = new OutputStreamWriter(java.nio.file.Files.newOutputStream(file.toPath()), UTF8_OVERRIDE && !UTF_BIG ? Charsets.UTF_8 : Charset.defaultCharset())) {
            writer.write(data);
        }
    }
